    ...
    <div class="createPost-container">
        <el-form ref="postForm" :model="postForm" :rules="rules" class="form-container">
            <sticky :z-index="10" :class-name="'sub-navbar ' + postForm.status">
                <el-button @click.native="togglePreview()" type="primary">预览</el-button>
            ...
            <div class="createPost-main-container">
                            ...
                            <el-row>
                                <el-col :span="8">
                                    <el-form-item label-width="60px" label="创建人:" class="postInfo-container-item">
                                        <el-select v-model="postForm.author" :remote-method="getRemoteUserList"
                                            filterable default-first-option remote placeholder="选择用户">
                                ...
                                <el-col :span="10">
                                    <el-form-item label-width="120px" label="发布时间:" class="postInfo-container-item">
                                        <el-date-picker v-model="displayTime" type="datetime"
                                            format="yyyy-MM-dd HH:mm:ss" placeholder="日期和时间" />
                                    </el-form-item>
                                </el-col>
                ...
                <el-form-item style="margin-bottom: 40px" label-width="70px" label="概述:">
                    <el-input v-model="postForm.content_short" :rows="1" type="textarea" class="article-textarea"
        ...
        <Preview ref="preview" :html="postForm"></Preview>
    </div>
</template>
...
export default {
    name: "ArticleDetail",
    components: { Tinymce, MDinput, Upload, Sticky, Preview },
    props: {
        isEdit: {
            type: Boolean,
            default: false,
    ...
    methods: {
        togglePreview() {
            this.$refs.preview.isVisible = !this.$refs.preview.isVisible;
        },
        fetchData(id) {
            fetchArticle(id)
                .then((response) => {
