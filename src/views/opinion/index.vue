  ...
  <ComponentsContainer>
    <div class="flex-style-column content-container">
      <div class="flex-style-base header-container">
        <search-comp :scoreTypeList="activeSTList" :level0StructList="level0StructList" @search="handleSearch"></search-comp>
...
<!--          </el-table-column>-->
          <template v-for="(column, index) in columns">
            <el-table-column sortable="custom" :prop="column.fieldCode" :label="column.fieldName" align="center"
...
export default {
  ...
  methods: {
    async initData() {
      ...
      this.level0StructList = await service.level0List()
      this.tableData = await service.page(this.param);
